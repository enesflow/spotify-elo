...
INSERT INTO "new_Track" ("album", "artist", "elo", "id", "image", "lost", "name", "spotifyId", "url", "userId", "won") SELECT "album", "artist", "elo", "id", "image", "lost", "name", "spotifyId", "url", "userId", "won" FROM "Track";
DROP TABLE "Track";
